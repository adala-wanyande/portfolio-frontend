...
import wec from '../assets/WorkHistory/wec-logo.jpg';

const WorkHistoryItem1 = () => {
  return (     
    <div id="work-history" class="max-w-lg min-w-min  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-4">
